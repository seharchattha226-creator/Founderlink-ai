...
const Register = () => {
  ...
  const { register, pendingUserEmail, loginWithGoogle, loginWithGithub } = useAuth();
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        ...
        // Errors handled in auth context with toasts
      } finally {
  ...
  return (
    <div className="min-h-screen bg-[#020617] flex text-[#F3F4F6] relative overflow-hidden">
      ...
      <div className="absolute top-[-10%] right-[-10%] w-[450px] h-[450px] bg-cyan-500/10 rounded-full blur-[120px] animate-[aurora-dance1_24s_ease-in-out_infinite] pointer-events-none" />
      <div className="absolute bottom-[-10%] left-[-10%] w-[450px] h-[450px] bg-violet-500/10 rounded-full blur-[120px] animate-[aurora-dance2_28s_ease-in-out_infinite] pointer-events-none" />

      <div className="w-full grid grid-cols-1 lg:grid-cols-12 min-h-screen relative z-10">
        
        {/* Left column (auth card) */}
        <div className="lg:col-span-6 flex flex-col justify-center items-center px-6 sm:px-10 lg:px-16 xl:px-20 py-12 relative order-2 lg:order-1">
          <motion.div
            ...
            <div className="relative z-10">
              ...
              <div className="relative mb-8">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-4 bg-[#020617] text-slate-500 font-medium">or sign up with email</span>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5 no-native-validation" noValidate>
                ...
                <div className="space-y-2">
                  <label htmlFor="name" className="block text-xs font-bold text-slate-300 uppercase tracking-widest ml-1">
                    Full Name
                  </label>
                  <div className="relative">
                    ...
                    <input
                      ...
                      className={`w-full pl-12 pr-4 py-4 bg-white/5 border rounded-2xl text-white text-sm placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-violet-500/30 focus:border-violet-500/50 transition-all duration-200 font-medium ${
                        errors.name && touched.name ? 'border-red-500/40 focus:border-red-500/60 focus:ring-red-500/20' : 'border-white/10'
                      }`}
                    />
                  </div>
                ...
                {/* Role Field */}
                <div className="space-y-2">
                  <label htmlFor="role" className="block text-xs font-bold text-slate-300 uppercase tracking-widest ml-1">
                    Role
                  </label>
                  <div className="relative">
                    ...
                    <select
                      ...
                      onChange={handleChange}
                      onBlur={handleBlur}
                      className="w-full pl-12 pr-10 py-4 bg-white/5 border border-white/10 hover:border-white/15 focus:border-violet-500/50 rounded-2xl text-white text-sm focus:outline-none focus:ring-1 focus:ring-violet-500/30 transition-all duration-200 font-medium appearance-none cursor-pointer"
                    >
                      <option value="Founder" className="bg-slate-900">Founder</option>
                      ...
                      <option value="Marketer" className="bg-slate-900">Marketer</option>
                    </select>
        ...
        <div className="hidden lg:flex lg:col-span-6 flex-col justify-between p-10 xl:p-16 relative overflow-hidden order-1 lg:order-2">
          ...
          >
            <div className="inline-flex items-center space-x-2 px-4 py-2 bg-white/5 border border-cyan-500/20 rounded-full text-sm font-semibold text-cyan-200">
            ...
            <h1 className="text-5xl xl:text-6xl font-black tracking-tight leading-tight">
              Build the future,
              <span className="gradient-text-hero"> one step at a time.</span>
            </h1>

            <p className="text-lg text-slate-400 leading-relaxed">
              Join thousands of founders using AI to validate, launch, and scale their startups faster than ever before.
            </p>
          </motion.div>
          ...
          >
            <div className="flex space-x-1 text-cyan-400 flex-shrink-0 mt-1">
              {[...Array(5)].map((_, i) => (
            ...
            <div className="space-y-2">
              <p className="text-sm text-slate-300 leading-relaxed font-medium">
                "We went from idea to MVP in 2 weeks using FounderLink. The AI co-founder is incredible."
              </p>
              <div className="text-xs font-bold text-white">Maya Patel, CTO at NovaAI</div>
            </div>
          </motion.div>
        </div>
      </div>
