...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary text-text-primary overflow-x-hidden">
      ...
      {/* Hero Section */}
      <section className="relative pt-40 pb-48 sm:pt-52 sm:pb-60 overflow-hidden">
        {/* Background - Matte Black with Organic Radial Lighting */}
        <div className="absolute inset-0">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[1200px] h-[1200px] bg-primary/3 rounded-full blur-[180px] pointer-events-none" />
          <div className="absolute top-1/3 -translate-y-1/2 right-0 w-[800px] h-[800px] bg-secondary/3 rounded-full blur-[150px] pointer-events-none" />
          <div className="absolute bottom-0 left-0 w-[900px] h-[900px] bg-primary/2 rounded-full blur-[160px] pointer-events-none" />
        </div>
          ...
          <div className="space-y-24">
            ...
            <div className="text-center max-w-4xl mx-auto space-y-10">
              <motion.div
                ...
                className="inline-flex items-center gap-3 px-5 py-2.5 bg-bg-surface/80 border border-border rounded-full text-caption text-text-tertiary"
              >
              ...
              <motion.h1
                ...
                className="text-hero sm:text-[80px] leading-[0.95] font-semibold tracking-tight"
              >
              ...
              <motion.p
                ...
                className="text-body-lg sm:text-xl text-text-secondary leading-relaxed max-w-2xl mx-auto"
              >
              ...
              >
                <Link
                  ...
                  className="group inline-flex items-center justify-center gap-3 bg-primary text-bg-primary rounded-xl px-8 py-4.5 font-medium transition-all hover:bg-primary/90 hover:-translate-y-1 active:translate-y-0 active:scale-[0.98] text-base"
                >
                ...
                <Link
                  to="/about"
                  className="group inline-flex items-center justify-center gap-3 bg-bg-elevated/50 text-text-primary rounded-xl px-8 py-4.5 font-medium border border-border transition-all hover:border-white/20 hover:bg-bg-surface active:scale-[0.98] text-base backdrop-blur-xl"
                >
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-5">
                ...
                <motion.div
                  ...
                  className="lg:col-span-7 bg-bg-surface/80 border border-border rounded-3xl p-7 backdrop-blur-xl"
                >
                  <div className="flex items-center justify-between mb-7">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center border border-primary/10">
                  ...
                  <motion.div
                    ...
                    className="flex items-center gap-3 text-sm bg-bg-primary border border-border rounded-2xl px-6 py-4"
                  >
                ...
                <div className="lg:col-span-5 space-y-5">
                  ...
                  <motion.div
                    ...
                    whileHover={{ y: -4, scale: 1.01 }}
                    className="bg-bg-surface/80 border border-border rounded-3xl p-7 backdrop-blur-xl"
                  >
                    ...
                    {[
                      ...
                      return (
                        <motion.div
                          ...
                          className="bg-bg-surface/80 border border-border rounded-3xl p-6 backdrop-blur-xl"
                        >
                ...
                <motion.div
                  ...
                  whileHover={{ y: -4, scale: 1.01 }}
                  className="lg:col-span-5 bg-bg-surface/80 border border-border rounded-3xl p-7 backdrop-blur-xl"
                >
                  <div className="flex items-center justify-between mb-6">
                    <div>
                  ...
                  <div className="h-32 flex items-end gap-2 px-1">
                    {[18, 28, 36, 32, 48, 62, 75, 70, 85, 96, 90, 100].map((height, i) => (
                      <motion.div
                        ...
                        transition={{ duration: 1, delay: 1.2 + i * 0.06 }}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
                      ...
                      <motion.div
                        ...
                        className="flex items-start gap-3 p-4 rounded-2xl bg-bg-primary hover:bg-bg-elevated transition-colors cursor-pointer border border-border hover:border-white/10"
                      >
                        <div className="mt-1.5">
                          <div className={`w-2 h-2 rounded-full ${rec.priority === 'High' ? 'bg-primary' : rec.priority === 'Medium' ? 'bg-secondary' : 'bg-warning'}`} />
                        </div>
                        <div className="flex-1">
                          <p className={`text-xs font-semibold mb-1 ${rec.priority === 'High' ? 'text-primary' : rec.priority === 'Medium' ? 'text-secondary' : 'text-warning'}`}>{rec.type}</p>
      ...
      <section className="py-24 sm:py-32 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="badge-primary mb-4">Product Preview</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            >
              ...
              <div className="space-y-5 mb-7">
                <div className="flex items-start gap-4">
                  <div className="w-9 h-9 rounded-xl bg-bg-primary border border-border flex items-center justify-center">
                    <User className="w-4.5 h-4.5" />
                  </div>
                  <div className="bg-bg-primary border border-border rounded-2xl rounded-tl-none p-4 max-w-[80%]">
                    <p className="text-sm text-text-secondary">How's our investor readiness looking? Do we need to refine the pitch deck?</p>
                  </div>
                </div>
                <motion.div
                  initial={{ opacity: 0, x: -10 }}
                ...
                >
                  <div className="w-9 h-9 rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 border border-primary/10 flex items-center justify-center">
                    <Brain className="w-4.5 h-4.5 text-primary" />
                  </div>
                  <div className="bg-gradient-to-br from-primary/5 to-secondary/5 border border-primary/10 rounded-2xl rounded-tr-none p-4 max-w-[85%]">
              ...
              <div className="flex items-center gap-3 bg-bg-primary border border-border rounded-2xl p-4">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold">Startup Health Score</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  <div key={i} className="bg-bg-primary border border-border rounded-xl p-4">
            ...
            >
              ...
              <div className="grid grid-cols-3 gap-4 mb-7">
                {[
                  ...
                  <div key={i} className="bg-bg-primary border border-border rounded-xl p-5 text-center">
              ...
              <div className="h-32 flex items-end gap-2 px-2">
                {[25, 40, 35, 55, 70, 65, 85, 90, 80, 95, 100].map((height, i) => (
                  <motion.div
                    ...
                    className={`flex-1 rounded-t-lg transition-colors ${
                      i >= 8 ? "bg-gradient-to-t from-primary to-primary/40" : "bg-bg-elevated"
                    }`}
                  />
                ))}
              </div>
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 p-4 bg-bg-primary border border-border rounded-xl hover:bg-bg-elevated transition-colors">
                    <div className={`w-9 h-9 rounded-lg flex items-center justify-center ${
                      item.done ? "bg-success/10 text-success" : "bg-bg-elevated text-text-tertiary"
                    }`}>
                      {item.done ? <CheckCircle2 className="w-4.5 h-4.5" /> : <Clock className="w-4.5 h-4.5" />}
                    </div>
                    <div className="flex-1">
            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-start gap-4 p-4 bg-bg-primary border border-border rounded-xl hover:bg-bg-elevated transition-colors">
                    <div className="mt-1">
      ...
      <section className="py-24 sm:py-32 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <span className="badge-primary mb-4">The AI Workflow</span>
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold tracking-tight mb-5">
          ...
          <div className="relative">
            ...
            <div className="absolute left-[23px] sm:left-[26px] lg:left-1/2 lg:-translate-x-1/2 top-0 bottom-0 w-px bg-bg-elevated"></div>
              ...
              {[
                {
                  ...
                  preview: (
                    <div className="bg-bg-primary border border-border rounded-2xl p-5 text-left">
                    ...
                    <div className="bg-bg-primary border border-border rounded-2xl p-5 text-left">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">Market Fit</p>
                          <p className="text-xl font-semibold text-success">8.2</p>
                        </div>
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">TAM</p>
                          <p className="text-xl font-semibold text-primary">$24B</p>
                        </div>
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">Competition</p>
                      ...
                      <div className="h-24 flex items-end gap-1.5">
                        {[25, 40, 35, 50, 65, 70, 85, 95].map((height, i) => (
                          <motion.div
                            ...
                            className={`flex-1 rounded-t-lg ${i >= 5 ? "bg-gradient-to-t from-primary to-primary/40" : "bg-bg-elevated"}`}
                          ></motion.div>
                        ))}
                      </div>
                      <p className="text-xs text-text-tertiary text-center mt-3">Market growth trajectory</p>
                    </div>
                  )
                },
                {
                  ...
                  preview: (
                    <div className="bg-bg-primary border border-border rounded-2xl p-5 text-left">
                      <div className="grid grid-cols-2 gap-4">
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">CAC</p>
                          <p className="text-2xl font-semibold text-primary">$120</p>
                        </div>
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">LTV</p>
                          <p className="text-2xl font-semibold text-secondary">$840</p>
                        </div>
                      </div>
                    </div>
                  )
                ...
                },
                {
                  ...
                  preview: (
                    <div className="bg-bg-primary border border-border rounded-2xl p-5 text-left flex items-center justify-center">
                      <div className="relative w-28 h-28">
                        <svg className="w-full h-full transform -rotate-90" viewBox="0 0 100 100">
                          <circle cx="50" cy="50" r="40" stroke="rgba(42,42,51,1)" strokeWidth="8" fill="none"></circle>
                          <motion.circle
                            initial={{ strokeDasharray: 251.2, strokeDashoffset: 251.2 }}
                            whileInView={{ strokeDashoffset: 27.632 }}
                            viewport={{ once: true }}
                            ...
                            cx="50" cy="50" r="40"
                            stroke="url(#funding-gradient)" strokeWidth="8"
                  ...
                  preview: (
                    <div className="bg-bg-primary border border-border rounded-2xl p-5 text-left">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="text-sm font-medium text-text-primary">15 slides ready</p>
                ...
                },
                {
                  ...
                  preview: (
                    <div className="bg-bg-primary border border-border rounded-2xl p-5 text-left">
                      <div className="grid grid-cols-3 gap-3">
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">MRR</p>
                          <p className="text-lg font-semibold text-text-primary">$12K</p>
                        </div>
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">Runway</p>
                          <p className="text-lg font-semibold text-text-primary">18mo</p>
                        </div>
                        <div className="text-center">
                          <p className="text-xs text-text-tertiary mb-1">Team</p>
                ...
                return (
                  <motion.div
                    ...
                    className={`relative flex gap-6 lg:gap-10 ${i % 2 === 0 ? "lg:flex-row" : "lg:flex-row-reverse"}`}
                  >
                    {/* Step Node */}
                    <div className="relative z-10">
                      ...
                      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-bg-primary border border-border flex items-center justify-center text-xs font-semibold text-text-primary">
                        {step.step}
                      </div>
                    </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-text-tertiary mb-6">{step.value}</p>
                      {step.preview}
                    </div>
                  </motion.div>
                );
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold">AI Startup Validation</h3>
                  <p className="text-sm text-text-tertiary">Validate before you build</p>
                </div>
              </div>
              <div className="bg-bg-primary border border-border rounded-2xl p-6 mb-6">
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Startup Roadmap</h3>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Market Research Engine</h3>
                  <p className="text-sm text-text-tertiary">Real‑time data insights</p>
                </div>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-bg-primary border border-border rounded-2xl p-5 text-center">
                ...
                <div className="bg-bg-primary border border-border rounded-2xl p-5 text-center">
                  ...
                  <p className="text-lg font-semibold text-text-primary mb-1">Mid‑Market</p>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Investor Readiness</h3>
            ...
            >
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Co‑Founder Matching</h3>
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={i} className="flex items-center gap-4 bg-bg-primary border border-border rounded-2xl p-5 hover:bg-bg-elevated transition-colors">
                    <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary/20 to-secondary/20 flex items-center justify-center border border-primary/10">
                      <span className="font-semibold text-sm">{person.name.split(' ')[0][0]}{person.name.split(' ')[1][0]}</span>
                    </div>
                    <div className="flex-1">
            ...
            <motion.div
              ...
              transition={{ duration: 0.7, delay: 0.5 }}
              whileHover={{ y: -4, transition: { duration: 0.2 } }}
              className="lg:col-span-3 bg-bg-surface border border-border rounded-3xl p-7 lg:p-8"
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-secondary/10 flex items-center justify-center">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Pitch Deck AI</h3>
              ...
              <div className="bg-bg-primary border border-border rounded-2xl p-5 text-center">
                <div className="flex items-center justify-center gap-2 mb-2">
                  <Check className="w-4 h-4 text-success" />
                  <span className="text-sm font-medium text-text-primary">Deck Generated</span>
                </div>
            ...
            <motion.div
              ...
              whileHover={{ y: -4, transition: { duration: 0.2 } }}
              className="lg:col-span-9 bg-bg-surface border border-border rounded-3xl p-7 lg:p-8"
            >
              <div className="flex items-center gap-4 mb-6">
                <div className="w-12 h-12 rounded-2xl bg-primary/10 flex items-center justify-center">
              ...
              <div className="h-28 flex items-end gap-2 px-2">
                {[30, 45, 40, 60, 75, 70, 90, 95, 88, 92, 100].map((height, i) => (
                  <motion.div
                    ...
                    className={`flex-1 rounded-t-lg transition-colors ${i >= 8 ? "bg-gradient-to-t from-primary to-primary/40" : "bg-bg-elevated"}`}
                  />
                ))}
              </div>
            </motion.div>
      ...
      <section className="py-24 sm:py-32 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {/* Pricing Plans Grid */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-24">
            ...
            >
              ...
              <Link
                to={user ? "/dashboard" : "/register"}
                className="group w-full inline-flex items-center justify-center gap-2 bg-bg-primary text-text-primary rounded-xl px-6 py-4 font-medium border border-border transition-all hover:border-white/20 active:scale-[0.98]"
              >
                Start for free
            ...
            <motion.div
              ...
              transition={{ duration: 0.7, delay: 0.1 }}
              whileHover={{ y: -4, transition: { duration: 0.2 } }}
              className="lg:col-span-4 bg-bg-primary border border-primary/30 rounded-3xl p-7 lg:p-8 relative overflow-hidden"
            >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-xs font-semibold text-primary px-3 py-1 rounded-full bg-primary/10">Recommended</span>
              </div>
              <div className="mb-8">
              ...
              <Link
                to={user ? "/dashboard" : "/register"}
                className="group w-full inline-flex items-center justify-center gap-2 bg-primary text-bg-primary rounded-xl px-6 py-4 font-medium transition-all hover:bg-primary/90 hover:scale-[1.01] active:scale-[0.98]"
              >
                Upgrade to Pro
                <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
              </Link>
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-xl font-semibold text-text-primary">Enterprise</h3>
          ...
          {/* Feature Comparison */}
          <div className="bg-bg-surface border border-border rounded-3xl p-7 lg:p-8">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-border">
                    ...
                    <th className="py-6 px-6 text-center text-sm font-semibold text-primary bg-primary/5 w-1/5">Pro</th>
                ...
                <tbody className="divide-y divide-border">
                  ...
                  <motion.tr initial={{ opacity: 0, y: 12 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                    ...
                    <td className="py-6 px-6 bg-primary/5">
                      <div className="space-y-4">
      ...
      <section className="py-24 sm:py-32 border-t border-border relative overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/4 w-[600px] h-[600px] bg-primary/3 rounded-full blur-[120px] pointer-events-none"></div>
        <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-secondary/3 rounded-full blur-[120px] pointer-events-none"></div>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-bg-surface border border-border rounded-full text-xs font-medium text-text-tertiary">
                <Sparkles className="w-4 h-4 text-primary" />
                <span>The next big startup starts here</span>
              </div>
              
              <h1 className="text-[44px] sm:text-[52px] leading-[1.05] font-semibold tracking-tight">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  to={user ? "/dashboard" : "/register"}
                  className="group inline-flex items-center justify-center gap-2 bg-primary text-bg-primary rounded-xl px-8 py-4 font-medium transition-all hover:bg-primary/90 hover:scale-[1.01] active:scale-[0.98]"
                >
                  Start building
                  <ArrowRight className="w-4 h-4 group-hover:translate-x-0.5 transition-transform" />
                </Link>
                ...
                <Link
                  to="/about"
                  className="group inline-flex items-center justify-center gap-2 bg-bg-surface text-text-primary rounded-xl px-8 py-4 font-medium border border-border transition-all hover:border-white/20 hover:bg-bg-primary active:scale-[0.98]"
                >
                  Explore the product
                </Link>
              </div>
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8, delay: 0.2 }}
              className="bg-bg-surface border border-border rounded-3xl p-6 lg:p-8"
            >
              <div className="flex items-center justify-between mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-sm font-semibold text-text-primary">Startup Health</p>
                    <p className="text-xs text-text-tertiary">Last updated 12s ago</p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="bg-bg-primary border border-border rounded-2xl p-5">
                  <p className="text-xs text-text-tertiary mb-2">Investor Score</p>
                  <p className="text-3xl font-semibold text-text-primary mb-1">89</p>
                  <div className="w-full h-1.5 bg-bg-elevated rounded-full overflow-hidden">
                    <div className="w-[89%] h-full bg-gradient-to-r from-primary to-secondary rounded-full"></div>
                  </div>
                </div>
                <div className="bg-bg-primary border border-border rounded-2xl p-5">
                  <p className="text-xs text-text-tertiary mb-2">TAM Estimate</p>
                  <p className="text-3xl font-semibold text-text-primary mb-1">$24B</p>
                  <p className="text-xs text-success flex items-center gap-1"><ArrowUpRight className="w-3 h-3"/> +12%</p>
                </div>
              </div>
              
              <div className="bg-bg-primary border border-border rounded-2xl p-5">
                <div className="flex items-center justify-between mb-3">
                  <p className="text-xs font-semibold text-text-primary">12-Month Roadmap</p>
                ...
                <div className="space-y-3">
                  {["MVP Launch", "Beta Testing", "Seed Funding", "Scale Operations"].map((item, i) => (
                    <div key={i} className="flex items-center justify-between">
                      ...
                      <p className="text-xs text-text-tertiary">{i < 2 ? "Complete" : "In Progress"}</p>
                    </div>
                  ))}
                </div>
              </div>
